module.exports = function(client) {
  ...
  client.query(`CREATE TABLE favorite__c (
   ...
   property__c CHARACTER VARYING(18) REFERENCES property__c(sfid)
    ...
    client.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('victor@ionicrealty.com', '617-244-3672', 'Hentati med  amin ', '617-244-3672', 'a0036000003SsK3AAK', 'Senior Broker', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/people/victor_ochoa.jpg');`);
  ...
  client.query(`INSERT INTO property__c (name, thumbnail__c, beds__c, location__longitude__s, address__c, baths__c, broker__c, description__c, sfid, state__c, city__c, zip__c, title__c, picture__c, price__c, location__latitude__s) VALUES ('121 Med Amin Hentati', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/realty/house09sq.jpg', 3, -71.0493270000000052, '121 Harborwalk', 3, 'a0036000003SsJwAAK', 'Lorem ipsum dolor sit amet', 'a0236000002NHKpAAO', 'MA', 'Boston', '02420', 'Seaport District Retreat', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/realty/house09.jpg', 450000, 42.3569499999999977);`);
